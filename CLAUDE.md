...
**Solving Socials** - A research platform for optimizing transparent AI social media personas. The goal is to explore algorithmic approaches to social media growth with full AI disclosure from day one.

**Research Question:** Can openly-AI accounts achieve popularity? What strategies work best?

**Type:** Web App (Dashboard + API)

**Key Features:** Persona Management | Performance Tracking | Content Analytics | Evolution Engine

**Stack:** TypeScript, Node.js, Vitest, Playwright, SQLite (initial)
...
| `personas/*.yaml` | Persona specifications (voice, style, content) | When generating content for personas |
